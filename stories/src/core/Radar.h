...
/* Exact three-point registration of the embedded 320x220 atlas.  The supplied
 * reference is this bitmap enlarged 4x and cropped by 95px left / 24px top;
 * its marked Shoreside, Staunton and Portland safehouses therefore provide
 * three independent world-to-texture anchors with no guessed landmarks. */
#define LCS_MENU_MAP_XX  0.0782302768f
#define LCS_MENU_MAP_XY  0.0003970529f
#define LCS_MENU_MAP_X_OFFSET 158.106154f
#define LCS_MENU_MAP_YX -0.0017029937f
#define LCS_MENU_MAP_YY -0.0812496454f
...
#define LCS_BOTTOM_MAP_TOP (-10.0f)
#define LCS_BOTTOM_MAP_RIGHT (334.55f)
#define LCS_BOTTOM_MAP_BOTTOM (230.0f)
#endif
...
public:
#ifdef ENABLE_3DS_BOTTOM_RADAR
	static bool m_bDrawingBottomScreen;
#endif
