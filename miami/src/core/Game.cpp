...
bool CGame::Initialise(const char* datFile)
{
	...
	SetLoadingScreenStage(0.0f, "Initialising pools");
#endif
	...
	PUSH_MEMID(MEMID_TEXTURES);
#ifdef ENABLE_3DS_LOADING_PROGRESS
	SetLoadingScreenProgress(0.02f);
#endif
...
#ifdef ENABLE_3DS_LOADING_PROGRESS
	SetLoadingScreenProgress(0.05f);
#endif
...
#ifdef ENABLE_3DS_LOADING_PROGRESS
	SetLoadingScreenProgress(0.08f);
#endif
...
#ifdef ENABLE_3DS_LOADING_PROGRESS
	SetLoadingScreenStage(0.15f, "Loading level definitions");
#endif
	CFileLoader::LoadLevel("DATA\\DEFAULT.DAT");
	CFileLoader::LoadLevel(datFile);
#ifdef ENABLE_3DS_LOADING_PROGRESS
	SetLoadingScreenProgress(0.30f);
#endif
...
#ifdef ENABLE_3DS_LOADING_PROGRESS
	SetLoadingScreenProgress(0.32f);
#endif
...
#ifdef ENABLE_3DS_LOADING_PROGRESS
	SetLoadingScreenProgress(0.34f);
#endif
...
#ifdef ENABLE_3DS_LOADING_PROGRESS
	SetLoadingScreenProgress(0.35f);
#endif
...
#ifdef ENABLE_3DS_LOADING_PROGRESS
	BeginLoadingScreenProgressRange(0.36f, 0.58f);
#endif
	CStreaming::LoadAllRequestedModels(false);
#ifdef ENABLE_3DS_LOADING_PROGRESS
	EndLoadingScreenProgressRange();
#endif
	CStreaming::RemoveIslandsNotUsed(currLevel);
	printf("Streaming uses %zuK of its memory", CStreaming::ms_memoryUsed / 1024); // original modifier was %d

#ifdef ENABLE_3DS_LOADING_PROGRESS
	SetLoadingScreenProgress(0.60f);
#endif
...
#ifdef ENABLE_3DS_LOADING_PROGRESS
	SetLoadingScreenProgress(0.67f);
#endif
	CStreaming::LoadInitialWeapons();
#ifdef ENABLE_3DS_LOADING_PROGRESS
	BeginLoadingScreenProgressRange(0.68f, 0.80f);
#endif
...
#ifdef ENABLE_3DS_LOADING_PROGRESS
	SetLoadingScreenProgress(0.84f);
#endif
	LoadingScreen("Loading the Game", "Loading radar and weapons", nil);
	CRadar::Initialise();
	CRadar::LoadTextures();
	CWeapon::InitialiseWeapons();

#ifdef ENABLE_3DS_LOADING_PROGRESS
	SetLoadingScreenProgress(0.86f);
#endif
...
#ifdef ENABLE_3DS_LOADING_PROGRESS
	SetLoadingScreenProgress(0.88f);
#endif
	LoadingScreen("Loading the Game", "Initialising population and effects", nil);
...
#ifdef ENABLE_3DS_LOADING_PROGRESS
	SetLoadingScreenProgress(0.90f);
#endif
...
#ifdef ENABLE_3DS_LOADING_PROGRESS
	SetLoadingScreenProgress(0.92f);
#endif
	LoadingScreen("Loading the Game", "Initialising world systems", nil);
...
#ifdef ENABLE_3DS_LOADING_PROGRESS
	SetLoadingScreenProgress(0.95f);
#endif
...
#ifdef ENABLE_3DS_LOADING_PROGRESS
	SetLoadingScreenProgress(0.97f);
#endif
...
#ifdef ENABLE_3DS_LOADING_PROGRESS
	SetLoadingScreenProgress(0.99f);
#endif
