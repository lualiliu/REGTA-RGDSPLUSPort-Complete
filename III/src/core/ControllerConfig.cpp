...
#ifdef _3DS
/* Keep 3DS gameplay hints independent of desktop controller settings.  These
 * are the labels printed on the console and match AffectFrom3DS exactly. */
#undef UP
#undef DOWN
#undef LEFT
#undef RIGHT
#define UP "CIRCLE PAD UP"
#define DOWN "CIRCLE PAD DOWN"
